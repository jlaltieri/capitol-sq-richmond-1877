// const theExtent = [-8621711.744059, 4514036.217532, -8619007.973219, 4515407.291003];
const lon_lat = [-77.437499, 37.540279];
const maxzoom=20
const minzoom=14
const initialzoom=16.5
const projection1='EPSG:4326'
const projection2='EPSG:3857'
...
var map = new ol.Map({
    ...
    view: new ol.View({
         ...
         center: ol.proj.transform(lon_lat, projection1, projection2), 
         zoom: initialzoom
    })
});

// Center map on richmond historical layer and set zoom to 16. Otherwise, it will default to
// maxZoom

// I have my own layer switcher controls, so I don't need this one.
// var layerSwitcher = new ol.control.LayerSwitcher({tipLabel: "Layers"});
// map.addControl(layerSwitcher);
// layerSwitcher.hidePanel = function() {};
// layerSwitcher.showPanel();

// Add ZoomToExtent control and set extent to center of richmond historical map
// It will default to the maxZoom if left to its own devices. I have added my own listener here so I can change size and zoom.
var zoomToExtentControl = new ol.control.ZoomToExtent({
    // extent: theExtent
    label: "C",
    tipLabel: "Click To Center Map"
    
  });
map.addControl(zoomToExtentControl);

// Here is where I add my own listener--must get the element in order to do that.
var zoomToExtentControl_Element = document.querySelector('.map .ol-zoom-extent');

zoomToExtentControl_Element.addEventListener('click', evt => {
    map.getView().setCenter(ol.proj.transform(lon_lat, projection1, projection2));
